...
(
    "id"                  bigint       not null,
    "action_done_by"      uuid         not null,
    "action_done_by_ip"   varchar(255) not null,
...
alter table if exists "livro_autor_assoc_aud"
...
alter table if exists "modified_entity_names"
